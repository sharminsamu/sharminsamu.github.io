...
<p style="text-align:justify; color:black; font-family:Georgia"> I am Sharmin Sultana Samu, a dedicated researcher and aspiring academic currently pursuing my MSc in Computer Science and Engineering (CSE) at <a href="https://www.bracu.ac.bd/">BRAC University</a>. With a strong passion for advancing the field of computing, I am driven by a deep curiosity about how intelligent systems can better understand and interact with humans.</p>
...
<details>
<summary><b>Vision Language Model (VLM)</b></summary>
<span><font size="3"> <p style="text-align:justify; color:black; font-family:Georgia"> <em>A multimodal AI research area that combines computer vision and natural language processing to enable machines to jointly understand images and text. My work focuses on building models that can reason across visual and linguistic inputs for tasks such as image captioning, visual question answering, and multimodal retrieval. A key research challenge I address involves improving fine-grained visual–text alignment and enhancing generalization in zero-shot and few-shot settings. I am also interested in developing more efficient and context-aware architectures that can better ground language in complex visual scenes.</em></p></font></span>
</details>

<br>

<p style="text-align:justify; color:black; font-family:Georgia"> As a prospective PhD student, I am actively preparing to contribute to cutting-edge research and collaborate with global scholars in multidisciplinary domains. I am committed to exploring innovative solutions to complex problems and aspires to make impactful contributions to both academia and industry.
</p>
